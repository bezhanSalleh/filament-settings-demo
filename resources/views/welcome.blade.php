                    ...
                    <div class="p-6">
                        <div class="flex items-center">
                            ...
                            <div class="ml-4 text-lg leading-7 font-semibold"><a href="https://laravel.com/docs"
                                    class="underline text-gray-900 dark:text-white">Site Settings</a></div>
                        </div>

                        <div class="ml-12">
                            <div class="mt-2 text-gray-600 dark:text-gray-400 text-sm">
                                <ul>
                                    <li>{{ $siteSettings->name }}</li>
                                    <li>{{ $siteSettings->slogan }}</li>
                                    <li><img height="50px" width="50px" src="{{ $siteSettings->logo }}" alt=""></li>
                                </ul>
                            </div>
                        </div>
                    </div>
